        ...
        <div class="col-md-12 mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                    <a href="<?php echo e(route('customers.downloadReport')); ?>" class="btn btn-success mb-3 <?php echo e($hasClusters ? '' : 'disabled'); ?>">Download Report</a>
                    </div>
                    <table class="table table-bordered" id="dataTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $dataPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dataPoint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($dataPoint->id); ?></td>
                                <td><?php echo e($dataPoint->age); ?></td>
                                <td><?php echo e($dataPoint->income); ?></td>
                                <td><?php echo e($dataPoint->cluster); ?></td>
                            </tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const clusters = <?php echo json_encode($clusters, 15, 512) ?>;
        const dataPoints = <?php echo json_encode($dataPoints, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhhasap/Documents/Kuliah/Data Mining/kmeans/resources/views/customers/visualization.blade.php ENDPATH**/ ?>